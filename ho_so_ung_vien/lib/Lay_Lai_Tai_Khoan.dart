          ...
          Row(
            children: <Widget>[
              Container(
                ...
                margin: EdgeInsets.only(left: 30,right: 30,top: 17),
                width: 300,
            ...
            children: <Widget>[
              Container(
                ...
                child: Text('(Hãy nhập số điện thoại bạn đã đăng ký)',
                    style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.bold,backgroundColor: Colors.redAccent)),
              )
            ],
          ),
          Row(
